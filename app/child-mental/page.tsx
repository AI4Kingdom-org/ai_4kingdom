...
export default function ChildMentalChatkitPage() {
  ...
  return (
    <WithChat chatType={CHAT_TYPES.CHILDREN_MENTAL} disableChatContext>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ width: '90%', maxWidth: 900, margin: '0 auto' }}>
            ...
            <div style={{ width: '100%', height: 450, borderRadius: 12, overflow: 'hidden', boxShadow: '0 4px 10px rgba(0,0,0,0.1)' }}>
              <ChatkitEmbed userId={user.user_id} module="child-mental" />
            </div>
          </div>
        </div>
      </div>
